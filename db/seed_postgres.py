...
def seed() -> None:
    ...
    try:
        ...
        pw = _hash_pw("pass123")
        clients = [
            (0, "VTB", "Community", "vtb_community", _hash_pw("vtb2026")),
        ...
        posts_data = [
            ...
            (0, "Кофеманы", "☕ Новый партнёр: Кофейня «Кофе и точка»",
            "Теперь кэшбэк 7% во всех кофейнях сети! Акция до конца месяца. Вступайте в сообщество и получайте выгоду.", None),
            (0, "Кофеманы", "Кофейный челлендж",
            "Друзья, запускаем челлендж: поделитесь фото вашего любимого кофе и получите дополнительный кэшбэк 5% на следующую покупку!", None),
            
            # Фитнес
            (0, "Фитнес", "💪 Новый фитнес-клуб в программе",
            "Сеть клубов «World Class» теперь с кэшбэком 8% для участников сообщества. Активируйте выгоду во вкладке «Акции».", None),
            (0, "Фитнес", "Онлайн-тренировки",
            "Запускаем серию онлайн-тренировок с тренерами. Первое занятие бесплатно для участников сообщества!", None),
            
            # Здоровье
            (0, "Здоровье", "🏥 Чек-ап со скидкой 20%",
            "Сеть лабораторий «Инвитро» даёт скидку 20% на комплексные анализы. Кэшбэк 10% по карте.", None),
            (0, "Здоровье", "Витамины с кэшбэком 15%",
            "Новый партнёр - iHerb. Кэшбэк 15% на все заказы для участников сообщества.", None),
            
            # Любители выпечки
            (0, "Любители выпечки", "🎂 Мастер-класс от шеф-повара",
            "Приглашаем на бесплатный мастер-класс по выпечке круассанов. Регистрация открыта!", None),
            (0, "Любители выпечки", "Новый партнёр: магазин «Мир муки»",
            "Скидка 10% на всю продукцию + кэшбэк 5% по карте. Промокод: VTBBAKING", None),
            
            # Кафе и рестораны
            (0, "Кафе и рестораны", "🍽️ Ресторанная неделя",
            "С 1 по 7 ноября скидка 15% во всех ресторанах-партнёрах. Список заведений в приложении.", None),
            (0, "Кафе и рестораны", "Новый раздел: Отзывы",
            "Добавили возможность оценивать заведения. За каждый отзыв - бонус 50 ₽ кэшбэка!", None),
            
            # Супермаркеты
            (0, "Супермаркеты", "🛒 Акция: суббота - двойной кэшбэк",
            "Каждую субботу в «Перекрёстке» и «Пятёрочке» двойной кэшбэк до 10%. Не пропустите!", None),
            (0, "Супермаркеты", "Совместные покупки",
            "Запускаем раздел совместных покупок. Экономьте вместе с сообществом до 30%!", None),
            
            # Красота
            (0, "Красота", "💄 Бьюти-бокс за 1 ₽",
            "Для участников сообщества: бьюти-бокс с косметикой за 1 ₽ при покупке от 2000 ₽ в «Л’Этуаль».", None),
            (0, "Красота", "Конкурс: лучший образ",
            "Выиграйте сертификат на 5000 ₽ в «Золотое яблоко». Условия конкурса в посте.", None),
            
            # АЗС
            (0, "АЗС", "⛽ Топливо со скидкой 5%",
            "По вторникам скидка 5% на АЗС «Лукойл» + кэшбэк 3% по карте.", None),
            (0, "АЗС", "Электрозарядки",
            "Теперь кэшбэк 10% на зарядку электромобилей на всех станциях «Россети».", None),
            
            # Автоуслуги
            (0, "Автоуслуги", "🔧 Сезонная скидка на шиномонтаж",
            "Скидка 20% на шиномонтаж в сети «Fit Service» для участников сообщества до 30 ноября.", None),
            (0, "Автоуслуги", "Новый партнёр: автомойка «Мойдодыр»",
            "Кэшбэк 15% на все услуги + бесплатная полировка в подарок при первом визите.", None),
            
            # Электроника
            (0, "Электроника", "📱 Розыгрыш iPhone 15",
            "Участвуйте в розыгрыше iPhone 15 среди активных участников сообщества. Условия: 3 поста или 10 комментариев.", None),
            (0, "Электроника", "Скидка 10% в М.Видео",
            "Промокод VTB10 на всю технику до конца года. Делитесь находками!", None),
            
            # Авиабилеты
            (0, "Авиабилеты", "✈️ Кэшбэк 10% на билеты",
            "Только до конца месяца: кэшбэк 10% на все авиабилеты, купленные через наш сервис.", None),
            (0, "Авиабилеты", "Секретные тарифы",
            "Специальные тарифы для участников сообщества от «Аэрофлота». Экономьте до 30%.", None),
            
            # Отели (добавим, если есть в MCC_CATEGORIES)
            (0, "Отели", "🏨 Раннее бронирование 2025",
            "Скидка 25% на отели при бронировании до января. Кэшбэк 8% сверху.", None),
            (0, "Отели", "Отели с завтраками",
            "Новая категория: отели с завтраками. Дополнительный кэшбэк 5%.", None),
            
            # Турагентства
            (0, "Турагентства", "🧳 Турпакеты со скидкой",
            "Туры в Таиланд и Турцию со скидкой 15% для участников. Кэшбэк до 10%.", None),
            
            # Duty Free
            (0, "Duty Free", "🛍️ Промокод на 10%",
            "Промокод VTB10 на все покупки в Duty Free в аэропортах России до 31 декабря.", None),
            
            # Ж/д билеты
            (0, "Ж/д билеты", "🚆 Кэшбэк 7% на поезда",
            "Покупайте билеты на «РЖД» через наш сервис и получайте 7% кэшбэка.", None),
        ]
